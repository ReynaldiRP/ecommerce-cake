<template>
    <section class="h-screen flex flex-col text-primary-color">
        <div class="grid grid-cols-1 gap-4 px-14 place-items-center">
            <h1 class="font-bold text-xl lg:text-2xl">
                Try Our Customize Cake
            </h1>
            <p class="w-1/2 font-light text-lg lg:text-xl text-center">
