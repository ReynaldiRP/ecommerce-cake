<template>
    <footer class="bg-gray-900 text-white relative overflow-hidden">
        ...
        ></div>
        <div
            class="absolute top-0 left-1/4 w-64 h-64 bg-primary/5 rounded-full blur-3xl"
        ></div>
                ...
                >
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <h3
                                class="text-2xl font-heading font-bold text-white"
                            >
                                Dream Dessert
                            </h3>
                        </div>
                        <p
                            class="text-gray-400 text-lg leading-relaxed mb-6 max-w-md"
                        >
                            Wujudkan kue impian Anda dengan cita rasa terbaik
                            dan kualitas premium. Dari kue custom hingga dessert
                            istimewa, kami hadir untuk momen manis Anda.
                        </p>
                        <!-- Social Media -->
                        <div class="flex space-x-4">
                            <a
                                href="#"
                                class="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary/20 transition-colors group"
                            >
                                <svg
                    ...
                    <div>
                        <h4
                            class="text-lg font-heading font-semibold text-white mb-6"
                        >
                            Menu Utama
                        </h4>
                        <ul class="space-y-3">
                ...
                <div class="container mx-auto px-6 lg:px-12 py-6">
                    ...
                    >
                        <p class="text-gray-400 text-center md:text-left">
                            © {{ new Date().getFullYear() }} Dream Dessert.
                            Dibuat dengan ❤️ oleh
                            <span class="text-primary font-medium"
                                >Reynaldi Rizky Pratama</span
                            >
                        </p>
